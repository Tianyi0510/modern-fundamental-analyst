...
type MonthlyPortfolioReturn = {
  readonly date: string;
  readonly marketValue: number;
} & (
  | { readonly portfolioXirr: number; readonly benchmarkXirr: number }
  | { readonly portfolioXirr: null; readonly benchmarkXirr: null }
);
...
] as const satisfies readonly [MonthlyPortfolioReturn, ...MonthlyPortfolioReturn[]];
