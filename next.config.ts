...
const securityHeaders = [
  { key: "Content-Security-Policy", value: "base-uri 'self'; form-action 'self' https://pay.modernfundamentalanalyst.com https://checkout.stripe.com; frame-ancestors 'none'" },
