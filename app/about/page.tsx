...
export const metadata: Metadata = { title: "About", description: "The perspective and principles behind GI's independent investment research." };
...
export default function AboutPage() {
  return <main><SiteHeader />
    ...
    <section className="two-column shell body-section">
      ...
      <div className="rich-copy"><p>GI is an independent public-equity research practice focused on understandable businesses, durable economics, and disciplined capital allocation.</p><p>This site is a transparent archive of the portfolio, performance record, and written investment work. It is designed to show how conclusions change as new evidence arrives.</p></div>
    </section>
