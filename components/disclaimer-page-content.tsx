  ...
  "zh-tw": {
    ...
    sections: [
      ...
      [
        ...
        null,
        [
          "過往績效不代表未來結果。已發布的投資組合與績效數據依據所揭露的方法、資料及假設計算，可能包含錯誤或限制，讀者應自行核實。",
        ],
      ],
      [
        "持股與利益衝突",
        null,
        [
          "本人可能持有本網站所討論的證券。已發布的觀點與持股可能隨時變更，恕不另行通知；相關部位或潛在利益衝突將在適當情況下揭露。",
        ],
      ],
    ],
  },
  "zh-cn": {
    ...
    sections: [
      ...
      [
        ...
        null,
        [
          "过往业绩不代表未来结果。已发布的投资组合与业绩数据依据所披露的方法、资料及假设计算，可能包含错误或限制，读者应自行核实。",
        ],
      ],
      [
        "持仓与利益冲突",
        null,
        [
          "本人可能持有本网站所讨论的证券。已发布的观点与持仓可能随时变更，恕不另行通知；相关持仓或潜在利益冲突将在适当情况下披露。",
        ],
      ],
    ],
  },
