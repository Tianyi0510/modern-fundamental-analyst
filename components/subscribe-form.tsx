...
const copy = {
  en: {
    ...
    success: "You’re subscribed. Check your inbox for a welcome email with a secure preferences link.",
  ...
  "zh-tw": {
    ...
    submit: "訂閱",
    submitting: "訂閱中…",
    success: "訂閱成功。請查看歡迎郵件中的安全偏好設定連結。",
  ...
  "zh-cn": {
    ...
    submit: "订阅",
    submitting: "订阅中…",
    success: "订阅成功。请查看欢迎邮件中的安全偏好设置链接。",
